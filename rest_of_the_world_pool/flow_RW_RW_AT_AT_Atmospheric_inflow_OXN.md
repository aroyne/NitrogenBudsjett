...
### Flow Description
Is found from source-receptor data from EMEP. Global multi-decadal estimates of inorganic nitrogen deposition patterns, including the regional variances and declines over Europe, are thoroughly documented by [^ackerman_global_2019], while the broader atmospheric chemical transport of combustion emissions is detailed in [^fowler_global_2013]. There is a change in methodology in the EMEP reporting between 2002 and 2003 data.
