...
### Flow Description
Is taken from FAOSTAT Fertilizer by nutrient FAO (2025). Because anhydrous ammonia is not used directly as fertilizer in Norway, it is not counted as a fertilizer in this particular FAO statistic. We therefore account for NH3 import in the flow **RW.RW-MP.OP-Ammonia import-Nmix**.
