...
Use the navigation menu on the left side to explore the individual nitrogen pools (e.g., Atmosphere, Rest of the World) and access detailed statistical time-series graphs, methodological explanations, and parameterizations for each specific flow.
