...
This NNB is built using the guidelines from ({winiwarter_inms_2025)}. Where flows are omitted or added to better fit the Norwegian nitrogen system, this is commented. 
### References
