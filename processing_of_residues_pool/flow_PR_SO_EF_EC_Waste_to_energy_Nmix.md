...
For years prior to 1995, we use the overall fraction of waste to incineration given in [^ssb_1997] and assume that the overall N content of the waste is equal to the 1995 value. For years with missing data, we interpolate.
