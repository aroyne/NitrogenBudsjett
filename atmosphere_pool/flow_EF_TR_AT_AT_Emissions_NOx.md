...
### Flow Description
EF.TR-AT.AT-Emissions-NOx denotes NOx emissions from fuel combustion. We have used data from CLRTAP Inventory Submissions emep_official_2025 (n.d.)} as advised by Schäppi et al. (2025), using the categories given in Table 13.
