...
![MP.OP-AT.AT-Emissions-NH3](../output_files/plots/MP_OP_AT_AT_Emissions_NH3.png)

### Flow Description
We have used data from CLRTAP Inventory Submissions (EMEP, 2025) as advised by (Schäppi, 2025), using the categories given in Table 20.
