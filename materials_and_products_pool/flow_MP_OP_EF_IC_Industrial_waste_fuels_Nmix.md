...
The net caloric value of 15.6 for conversion is taken from table 1.2 in Garg et al. (2006)<!--cite:garg_chapter_2006--> and we assume a mean N content of 4.0 kg/t the same whole-tree average used for fuel wood (see FS.FO-EF.OE-Fuel wood for households-Nmix), since industrial waste wood (bark, sawdust, black liquor) is closer in composition to whole-tree biomass than to clean stem wood.

SSB has not reported data on this energy category before 1998, but the size of these industries was relatively constant through the period 1991-2001 (Spilde & Aasestad, 2004)<!--cite:spilde_energibruk_2004-->. For years 1990-1997 we have therefore used the average for the next 10 years (1998-2007).
