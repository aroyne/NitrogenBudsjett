---
layout: default
title: Feed to Coastal Aquaculture
...
### Flow Description
**MP.FP-HY.AC-Feed to coastal aquaculture-Nmix**: the amount of feed per ton of produced fish is found by assuming an average protein (N) retention of 35.37 % based on values from Aas (2022). The amount of produced fish is found by using data from Fiskeridirektoratet (Fiskeridirektoratet, 2025) on sold farmed fish.
