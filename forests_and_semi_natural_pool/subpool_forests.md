...
* Because the N-flow in forest fertilization is not large, we have chosen to ignore the associated N2O emissions that were included in the Swedish NBB (moldan_2025).

### References

* Missing reference data for key: `moldan_2025`
